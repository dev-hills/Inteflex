    ...
    <div class="py-[70px] px-[65px] sm:px-[15px] w-[950px] mx-auto shadow-[0_20px_26px_12px_#10182814] sm:w-[100%]">
      ...
      <div class="mt-[27px] flex flex-row sm:flex-col items-center justify-between gap-[50px]">
        <div class="w-[50%] sm:w-[100%]">
          ...
          <input
            type="email"
            class="border-[1.2px] border-[#B4BEC8] w-[100%] rounded-[4px] p-[15px] outline-none mt-[27px]"
            placeholder="Email Address"
          />

          <textarea
            rows="5"
            class="border-[1.2px] border-[#B4BEC8] w-[100%] rounded-[4px] p-[15px] outline-none resize-none mt-[27px]"
            placeholder="Your Message"
          />

          <button
            class="w-[100%] bg-[#2E3192] p-[12px] rounded-[8px] text-white text-[14px] mt-[70px]"
          >
            Send
          </button>
        </div>
